...
public class ClienteController {
    ...
    //Este siguiente metodo es una manera diferente de subir y ver la foto del cliente
    ...
    public ResponseEntity<Resource> verFoto(@PathVariable String filename){
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION,"attacht; filename=\""+ recurso.getFilename() +"\"" ).body(recurso);
    }
